...
void Material::display_table(double xmouse, double ymouse, double deltax, double deltay, int** table) {
        float red, green, blue;
...
void Material::display_matrix(int **table, double deltax, double deltay) {
        for (int i = 0; i < 2* N; ++i) {
                for (int j = 0; j < 2 * N; ++j) {
                        double x, y;
                        x = i * a_square + a_square/2;
